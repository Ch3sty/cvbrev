...
// Next.js 16: cookies() från next/headers fungerar INTE i middleware
// Använd request.cookies istället
...
export async function adminAuthMiddleware(request: NextRequest) {
  ...
  // Next.js 16: Skapa response för att kunna hantera cookies korrekt
  ...
  try {
    ...
    // Användaren är super_admin, returnera response med uppdaterade cookies
 ...
 * OBS: Denna funktion använder request.cookies för Next.js 16 kompatibilitet
 */
