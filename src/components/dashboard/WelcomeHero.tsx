...
export default function WelcomeHero({
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-white via-slate-50/50 to-blue-50/20 backdrop-blur-sm rounded-2xl border border-slate-200/60 shadow-lg p-4 sm:p-6 lg:p-8 mb-8"
    >
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between">
        ...
        <div className="flex-1">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-gradient-to-r from-pink-600 to-purple-600 text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg"
          >
