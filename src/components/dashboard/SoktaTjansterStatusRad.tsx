  ...
  return (
    <motion.div
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="font-semibold text-neutral-900 text-base truncate">{parts.join(' · ')}</div>
      ...
      <Link
        ...
        className="group inline-flex items-center justify-center gap-1.5 text-xs font-semibold px-3.5 py-2 rounded-xl text-white flex-shrink-0 transition-all duration-200 hover:-translate-y-0.5 min-h-[40px]"
        style={{
