...
describe('Bli upptäckt: synligheten ingår i Allt', () => {
  const text = allt(BLI_UPPTACKT_FAQ_ITEMS)
  it('en fråga säger vad det kostar, med Allts priser ur PLANS', () => {
...
describe('LinkedIn: optimeringen ingår i CV-veckan och Allt', () => {
  ...
  it('kostnadsfrågan nämner CV-veckan och Allt med priser ur PLANS', () => {
