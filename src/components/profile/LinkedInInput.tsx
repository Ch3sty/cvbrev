    ...
    <div>
      <div className="flex items-center justify-between mb-1">
        <label htmlFor="linkedin_url" className="block text-sm font-medium text-gray-300">
          LinkedIn-profil <span className="text-xs text-gray-400 font-normal">(Valfritt)</span>
        </label>
      ...
      <div className="relative">
        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          <div className="w-5 h-5 text-blue-400 bg-blue-500/20 rounded flex items-center justify-center">
        ...
        <input
          ...
          disabled={disabled}
          className={`w-full pl-11 pr-3 py-2 rounded-md bg-navy-700 text-white border ${
            displayError 
