...
interface CvPreviewShellProps {
  yrke: string;
  children: ReactNode;
}

/**
 * Premium-shell runt InteractiveCVPreview.
 *
 * Lägger orange/röd-DNA ramar RUNT befintlig preview-komponent utan att
 * ändra dess innehåll.
 */
export default function CvPreviewShell({ yrke, children }: CvPreviewShellProps) {
  return (
    <motion.div
    ...
    >
      ...
      >
        ...
        >
          ...
          <rect width="100%" height="100%" fill="url(#cv-shell-dots)" />
        </svg>
        ...
        <div className="relative flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <Link href="/dashboard/skapa-cv" className="block w-full sm:w-auto">
