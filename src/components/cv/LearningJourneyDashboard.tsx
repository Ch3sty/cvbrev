...
import {
  Target, TrendingUp, Clock, Award, BookOpen,
  Sparkles, Map,
  Calendar, Trophy, Brain, CheckCircle2, Info
} from 'lucide-react';
      ...
      <div className="space-y-4">
        ...
        {Object.entries(learningPhases).map(([key, phase], index) => {
          ...
          return (
            <div
              key={key}
              className={`bg-white/80 backdrop-blur-xl rounded-xl border ${
                isAccessible ? 'border-gray-200/50' : 'border-gray-200/30 opacity-60'
              } overflow-hidden transition-all hover:border-blue-300 shadow-lg`}
            >
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  ...
                  {isAccessible && index === 0 && (
                    <button className="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-medium text-sm hover:shadow-lg transition-all">
                      Börja här →
                    </button>
                  )}
                </div>
                ...
                {isAccessible && (
                  <div className="grid grid-cols-2 gap-3 mt-4">
                    ...
                    {phase.skills.length > 4 && (
                      <div className="bg-gray-50 rounded-lg p-3 flex items-center justify-center text-sm text-gray-600 border border-gray-200">
