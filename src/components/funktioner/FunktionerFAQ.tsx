...
const FAQ_ITEMS = [
  {
    ...
    a: 'ChatGPT är ett generellt språkverktyg utan koll på svenska arbetsmarknaden, ATS-system eller hur rekryterare faktiskt sållar ansökningar. Vi är byggda för exakt det. Våra verktyg läser ditt CV, matchar mot annonsens krav och optimerar för de system som svenska arbetsgivare använder. Plus att vi inte kräver att du ska skriva en bra prompt för att få ett bra resultat.',
  },
  {
    q: 'Är det säkert att lämna mitt CV till er?',
    a: 'Ja. Vi följer GDPR, all data lagras i EU och vi säljer aldrig din information vidare. Du kan när som helst radera ditt konto med ett klick. Då försvinner allt, även våra kopior. Vi använder inte ditt CV för att träna någon modell.',
  },
  {
...
export default function FunktionerFAQ() {
