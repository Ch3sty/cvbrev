    ...
    >
      <div className={isMobile ? 'px-3.5 py-3' : 'px-4 py-4'}>
        <div className="flex items-center gap-2 mb-2">
          <span
            className="w-1 h-2.5 rounded-sm bg-orange-600"
            aria-hidden="true"
          />
        ...
        >
          <span
            className={`inline-flex items-center gap-1 ${
              email.trim() ? 'text-neutral-600' : 'text-neutral-300'
            }`}
          >
        ...
        {!isMobile && (
          <div className="mt-3 pt-3 border-t border-orange-50 space-y-1.5">
            ...
            <div className="space-y-1">
              ...
              <div className="h-1.5 rounded-full bg-neutral-100 w-1/2" />
            </div>
            ...
            <div className="flex flex-wrap gap-1">
              ...
              <span className="h-1.5 w-10 rounded-full bg-neutral-100" />
