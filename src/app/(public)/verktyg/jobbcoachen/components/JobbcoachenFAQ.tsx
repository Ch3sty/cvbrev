...
import { JOBBCOACHEN_FAQ_ITEMS } from './jobbcoachen-faq-data'

export default function JobbcoachenFAQ() {
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 leading-[1.05] tracking-tight mb-3">
            Vanliga frågor om karriärrådgivning
          </h2>
        ...
        <div className="space-y-3">
          {JOBBCOACHEN_FAQ_ITEMS.map((item, idx) => {
