...
import SkapaCvLiveDemo from './SkapaCvLiveDemo'

const TRUST = ['Helt gratis att börja', 'ATS-säkra mallar', 'PDF och Word']
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-16 sm:pt-16 sm:pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_1fr] gap-10 lg:gap-12 items-center">
          ...
          >
            ...
            {/* H1 - exakt match till primary keyword "skapa cv" */}
            ...
            <p className="text-base sm:text-lg lg:text-xl text-slate-600 leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0">
              Vår CV-byggare guidar dig genom sju enkla steg med live-preview.
              Du fyller i, vi sätter ihop CV:t och du laddar ner som PDF eller
              Word. Helt gratis, helt på svenska.
            </p>
