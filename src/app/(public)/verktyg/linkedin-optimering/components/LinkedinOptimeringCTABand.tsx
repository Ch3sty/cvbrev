...
import { LinkedinOptimeringHeroIcon } from './illustrations/LinkedinOptimeringIcons'

export default function LinkedinOptimeringCTABand() {
  return (
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-8 items-center">
            <div className="text-center lg:text-left">
              ...
              <p className="text-base sm:text-lg text-white/85 leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0">
                En optimering gratis i veckan, ingen kortuppgift, ingen
                inloggning på din LinkedIn. Du klistrar in din text, vi
                förbättrar fem sektioner samtidigt.
              </p>
              ...
              <div className="mt-5 flex flex-wrap items-center justify-center lg:justify-start gap-x-4 gap-y-1.5 text-sm text-white/85">
                <span>1 optimering gratis i veckan</span>
                <span className="hidden sm:inline text-white/40">·</span>
                <span>Vi loggar inte in</span>
                <span className="hidden sm:inline text-white/40">·</span>
                <span>5 minuter klart</span>
              </div>
            </div>

            <div className="hidden lg:flex items-center justify-center">
              <div className="bg-white/15 backdrop-blur-sm rounded-3xl p-6 border border-white/25">
                <LinkedinOptimeringHeroIcon className="w-44 h-44" />
              </div>
            </div>
          </div>
        </motion.div>
