...
const STATS = [
  {
    value: '1 gratis',
    label: 'optimering varje vecka',
    sub: 'Ingen kortuppgift, börja direkt',
  },
  {
    value: '5 sektioner',
    label: 'bearbetas samtidigt',
    sub: 'Rubrik, Om mig, Erfarenhet, Utbildning, Kompetenser',
  },
  {
    value: 'Score',
    label: 'före och efter per sektion',
    sub: 'Du ser exakt vad som blev bättre',
  },
]

export default function LinkedinOptimeringResultatBevis() {
  return (
          ...
          >
            ...
            <div className="relative">
              ...
              <blockquote className="text-base sm:text-lg text-slate-800 leading-relaxed font-medium mb-5">
                ”Hade aldrig fått ett rekryterar-meddelande på LinkedIn på två
                år. Optimerade min rubrik och om-mig på en eftermiddag och fick
                åtta meddelanden de följande två veckorna. Två blev faktiska
                intervjuer.”
              </blockquote>
              ...
              <div className="flex items-center gap-4 pt-5 border-t border-orange-100">
                ...
                <div>
                  <div className="text-sm font-bold text-slate-900">
                    Från noll till åtta meddelanden på två veckor
                  </div>
