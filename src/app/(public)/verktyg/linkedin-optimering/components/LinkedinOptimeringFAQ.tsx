...
import { LINKEDIN_OPTIMERING_FAQ_ITEMS } from './linkedin-optimering-faq-data'

export default function LinkedinOptimeringFAQ() {
    ...
    <section className="relative py-16 sm:py-24 bg-orange-50/30">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-3">
          {LINKEDIN_OPTIMERING_FAQ_ITEMS.map((item, idx) => {
