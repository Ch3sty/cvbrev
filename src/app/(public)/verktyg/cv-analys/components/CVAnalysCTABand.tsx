...
import { CVAnalysHeroIcon } from './illustrations/CVAnalysIcons'

export default function CVAnalysCTABand() {
  return (
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-8 items-center">
            <div className="text-center lg:text-left">
              ...
              <p className="text-base sm:text-lg text-white/85 leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0">
                Ladda upp ditt CV och se exakt vad som lyfter det och vad som
                drar ner det. Helt gratis, utan kortuppgift.
              </p>
            ...
            <div className="hidden lg:flex items-center justify-center">
              <div className="bg-white/15 backdrop-blur-sm rounded-3xl p-6 border border-white/25">
                <CVAnalysHeroIcon className="w-44 h-44" />
              </div>
            </div>
          </div>
        </motion.div>
