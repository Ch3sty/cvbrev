...
const STATS = [
  ...
  { value: '1', label: 'analys gratis per konto', sub: 'Ingen kortuppgift för att börja' },
  { value: '+27', label: 'poäng i snitt', sub: 'Vad våra användare ökar mellan första och andra analysen' },
]

export default function CVAnalysResultatBevis() {
  return (
          ...
          >
            ...
            <div className="relative">
              ...
              <blockquote className="text-base sm:text-lg text-slate-800 leading-relaxed font-medium mb-5">
                ”Jag fick 64 i ATS-poäng på första analysen och insåg att jag
                inte hade kvantifierat något alls. Efter en eftermiddag med
                förslagen var jag uppe i 91. Tre veckor senare hade jag tre
                intervjuer.”
              </blockquote>
