...
const STATS = [
  {
    value: 'Grundnivån',
    label: 'gratis, 1 gång per dygn',
    sub: 'Ingen kortuppgift, börja direkt',
  },
  {
    value: 'Detaljerad',
    label: 'rapport per pass',
    sub: 'Score, tid och fråga-för-fråga',
  },
  {
    value: 'Testveckan',
    label: 'tar bort taket',
    sub: 'Alla nivåer, provläget och din historik',
  },
]

export default function RekryteringstesterResultatBevis() {
  return (
          ...
          >
            ...
            <div className="relative">
              ...
              <blockquote className="text-base sm:text-lg text-slate-800 leading-relaxed font-medium mb-5">
                ”Hade aldrig gjort ett rekryteringstest innan Klarnas
                urvalsprocess och fick total panik första gången jag
                provade. Tränade två veckor med matrislogiken och
                numeriska testet här, klarade skarpa testet och fick
                tjänsten.”
              </blockquote>
              ...
              <div className="flex items-center gap-4 pt-5 border-t border-orange-100">
                ...
                <div>
                  <div className="text-sm font-bold text-slate-900">
                    Klarade Klarnas urvalstest efter två veckor
                  </div>
                  <div className="text-xs text-slate-500">
                    Junior Data Analyst, Klarna
                  </div>
                </div>
              </div>
            </div>
