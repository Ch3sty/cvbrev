...
const STATS = [
  {
    value: '3 min',
    label: 'från val till färdigt CV',
  ...
  },
  {
    ...
    sub: 'Båda formaten ingår alltid',
  },
]

export default function CVMallarResultatBevis() {
  return (
          ...
          >
            ...
            <div className="relative">
              ...
              <blockquote className="text-base sm:text-lg text-slate-800 leading-relaxed font-medium mb-5">
                ”Jag hade suttit i två veckor och försökt få Word att se rätt
                ut. Bytte till en av era mallar, fyllde i mina uppgifter på
                tjugo minuter och hade tre intervjuer bokade veckan efter.”
              </blockquote>
              ...
              <div className="flex items-center gap-4 pt-5 border-t border-orange-100">
                ...
                <div>
                  <div className="text-sm font-bold text-slate-900">
                    Två veckor till tjugo minuter
                  </div>
                  <div className="text-xs text-slate-500">
                    Ekonomiassistent, nu på SEB
                  </div>
                </div>
              </div>
            </div>
