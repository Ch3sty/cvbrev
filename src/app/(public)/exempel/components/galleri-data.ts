/**
 * Galleri-yrken extraherade fran tidigare hardkodad lista.
 * Anvands av /cv-exempel och /personligt-brev-exempel galleri-sidorna.
 */
import { GalleriYrke } from './GalleriPageContent'
...
export const CV_GALLERI: GalleriYrke[] = [
  ...
  },
  {
    ...
    "namn": "Servitris/Restaurangbiträde",
    "kategori": "service",
