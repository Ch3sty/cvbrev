/**
 * Den delade vyn: next.config.ts skriver om /rakna-ut/semesterersattning hit när länken
...
export async function generateMetadata({ searchParams }: DeladProps): Promise<Metadata> {
  return deladMetadata('semesterersattning', sidansMetadata, await searchParams)
}
