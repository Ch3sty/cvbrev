/**
 * Den delade vyn: next.config.ts skriver om /rakna-ut/timlon-till-manadslon hit när länken
...
export async function generateMetadata({ searchParams }: DeladProps): Promise<Metadata> {
  return deladMetadata('timlon-till-manadslon', sidansMetadata, await searchParams)
}
