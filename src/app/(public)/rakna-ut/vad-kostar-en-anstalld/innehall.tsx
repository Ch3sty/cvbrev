...
import KalkylatorSida from '@/components/rakna/KalkylatorSida'
import type { Sok } from '@/lib/rakna/sok'
import AnstalldKostnadStart from '@/components/rakna/start/vad-kostar-en-anstalld'
...
/** Sidans innehåll, delat av den statiska sidan och den delade vyn (./delad). */
export function Innehall({ sok }: { sok?: Sok } = {}) {
  return (
    <KalkylatorSida
      kategori="rekryterare"
      kalkylator={<AnstalldKostnadStart sok={sok} />}
