/**
 * Den delade vyn: next.config.ts skriver om /rakna-ut/lon-efter-skatt hit när länken
...
export async function generateMetadata({ searchParams }: DeladProps): Promise<Metadata> {
  return deladMetadata('lon-efter-skatt', sidansMetadata, await searchParams)
}
