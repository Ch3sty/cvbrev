...
import { REKRYTERARE_FAQ_ITEMS } from './rekryterare-faq-data'

/**
 * FAQ i samma accordion-mönster som verktygssidorna
 * (se BrevFAQ i /verktyg/personligt-brev).
 */
export default function RekryterareFAQ() {
    ...
    <section className="relative py-16 sm:py-24 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-3">
          {REKRYTERARE_FAQ_ITEMS.map((item, idx) => {
