...
export default function Demo1Page() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-slate-50/50">
      ...
      {/* Premium Navigation Bar with Mega Menu */}
      <nav className="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-lg border-b border-slate-200/60 z-50 shadow-sm">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex items-center gap-8">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-1/2 transform -translate-x-1/2 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                  <div className="bg-white rounded-xl shadow-xl border border-slate-200/80 p-6 min-w-[280px]">
                    <div className="grid gap-3">
                      <Link href="/cv-mallar" className="flex items-center gap-3 p-3 rounded-lg hover:bg-blue-50 hover:border-blue-100 border border-transparent transition-all group">
                        ...
                        <div>
                          <div className="font-medium text-slate-900 group-hover:text-blue-600 transition-colors">CV-mallar</div>
                          <div className="text-xs text-slate-500">Professionella mallar för alla branscher</div>
                        </div>
                      </Link>
                      <Link href="/personliga-brev" className="flex items-center gap-3 p-3 rounded-lg hover:bg-blue-50 hover:border-blue-100 border border-transparent transition-all group">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-purple-100 to-pink-100 flex items-center justify-center">
                          <Mail className="w-5 h-5 text-purple-600" />
                        </div>
                        <div>
                          <div className="font-medium text-slate-900 group-hover:text-purple-600 transition-colors">Personliga brev</div>
                          <div className="text-xs text-slate-500">AI-genererade följebrev som imponerar</div>
                        </div>
                      </Link>
                      <Link href="/linkedin-optimering" className="flex items-center gap-3 p-3 rounded-lg hover:bg-blue-50 hover:border-blue-100 border border-transparent transition-all group">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-blue-100 to-cyan-100 flex items-center justify-center">
                          <Globe className="w-5 h-5 text-blue-600" />
                        </div>
                        <div>
                          <div className="font-medium text-slate-900 group-hover:text-blue-600 transition-colors">LinkedIn-optimering</div>
                          <div className="text-xs text-slate-500">Optimera din profil för rekryterare</div>
                        </div>
                      </Link>
                    </div>
                  </div>
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-1/2 transform -translate-x-1/2 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                  <div className="bg-white rounded-xl shadow-xl border border-slate-200/80 p-6 min-w-[280px]">
                    <div className="grid gap-3">
                      <Link href="/intervjutraning" className="flex items-center gap-3 p-3 rounded-lg hover:bg-blue-50 hover:border-blue-100 border border-transparent transition-all group">
                        ...
                        <div>
                          <div className="font-medium text-slate-900 group-hover:text-green-600 transition-colors">Intervjuträning</div>
                          <div className="text-xs text-slate-500">Öva med AI och bli intervjusäker</div>
                        </div>
                      </Link>
                      <Link href="/karriarcoaching" className="flex items-center gap-3 p-3 rounded-lg hover:bg-blue-50 hover:border-blue-100 border border-transparent transition-all group">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-orange-100 to-red-100 flex items-center justify-center">
                          <TrendingUp className="w-5 h-5 text-orange-600" />
                        </div>
                        <div>
                          <div className="font-medium text-slate-900 group-hover:text-orange-600 transition-colors">Karriärcoaching</div>
                          <div className="text-xs text-slate-500">Personlig vägledning för din karriär</div>
                        </div>
                      </Link>
                    </div>
                  </div>
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-1/2 transform -translate-x-1/2 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                  <div className="bg-white rounded-xl shadow-xl border border-slate-200/80 p-6 min-w-[240px]">
                    <div className="grid gap-3">
                      <Link href="/blogg" className="flex items-center gap-3 p-3 rounded-lg hover:bg-blue-50 hover:border-blue-100 border border-transparent transition-all group">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-indigo-100 to-purple-100 flex items-center justify-center">
                          <BookOpen className="w-5 h-5 text-indigo-600" />
                        </div>
                        <div>
                          <div className="font-medium text-slate-900 group-hover:text-indigo-600 transition-colors">Blogg</div>
                          <div className="text-xs text-slate-500">Tips och guider för jobbsökning</div>
                        </div>
                      </Link>
                    </div>
                  </div>
              ...
              <Link href="/om-oss" className="text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors">
                Om oss
              </Link>
              <Link href="/kontakt" className="text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors">
                Kontakt
              </Link>
            </div>
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              <Link
                href="/register"
                className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-semibold rounded-lg hover:shadow-lg hover:shadow-blue-500/25 hover:scale-105 transition-all duration-300"
              >
                Starta gratis
              </Link>
            </div>
            ...
            >
              <div className="container mx-auto px-4 py-6">
                <div className="grid gap-6">
                  {/* Tjänster sektion */}
                  <div>
                    <h3 className="text-sm font-semibold text-slate-900 mb-3">Tjänster</h3>
                    <div className="grid gap-2 pl-4">
                      <Link href="/cv-mallar" className="flex items-center gap-3 py-2 text-slate-600 hover:text-blue-600 transition-colors">
                        <FileText className="w-4 h-4" />
                        CV-mallar
                      </Link>
                      <Link href="/personliga-brev" className="flex items-center gap-3 py-2 text-slate-600 hover:text-purple-600 transition-colors">
                        <Mail className="w-4 h-4" />
                        Personliga brev
                      </Link>
                      <Link href="/linkedin-optimering" className="flex items-center gap-3 py-2 text-slate-600 hover:text-blue-600 transition-colors">
                  ...
                  {/* Karriärcoaching sektion */}
                  <div>
                    <h3 className="text-sm font-semibold text-slate-900 mb-3">Karriärcoaching</h3>
                    <div className="grid gap-2 pl-4">
                      <Link href="/intervjutraning" className="flex items-center gap-3 py-2 text-slate-600 hover:text-green-600 transition-colors">
                        <MessageCircle className="w-4 h-4" />
                        Intervjuträning
                      </Link>
                      <Link href="/karriarcoaching" className="flex items-center gap-3 py-2 text-slate-600 hover:text-orange-600 transition-colors">
                  ...
                  <div className="grid gap-2">
                    <Link href="/blogg" className="flex items-center gap-3 py-2 text-slate-600 hover:text-indigo-600 transition-colors">
                      <BookOpen className="w-4 h-4" />
                      Blogg
                    </Link>
                    <Link href="/priser" className="flex items-center gap-3 py-2 text-slate-600 hover:text-slate-900 transition-colors">
                      <DollarSign className="w-4 h-4" />
                      Priser
                    </Link>
                    <Link href="/om-oss" className="flex items-center gap-3 py-2 text-slate-600 hover:text-slate-900 transition-colors">
                      <Building2 className="w-4 h-4" />
                      Om oss
                    </Link>
                    <Link href="/kontakt" className="flex items-center gap-3 py-2 text-slate-600 hover:text-slate-900 transition-colors">
                  ...
                  <div className="grid gap-3 pt-4 border-t border-slate-200">
                    <Link href="/login" className="py-3 text-center text-slate-600 hover:text-slate-900 transition-colors">
                      Logga in
                    </Link>
                    <Link
                      href="/register"
                      className="py-3 px-6 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-center font-semibold rounded-lg hover:shadow-lg transition-all"
                    >
                      Starta gratis
                    </Link>
                  </div>
