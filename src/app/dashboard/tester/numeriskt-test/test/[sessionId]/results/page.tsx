    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-4 lg:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl border-2 border-blue-200 p-8 mb-6 shadow-xl"
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-6">
            ...
            <div className="text-center p-4 bg-blue-50 rounded-xl border border-blue-200 col-span-2 md:col-span-1">
              ...
              <p className="text-xs text-blue-600 font-medium">Snitt per fråga</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <Button
            ...
            variant="outline"
            className="flex-1 py-6 border-2 border-blue-300"
          >
          ...
          <Button
            onClick={() => router.push('/dashboard/tester/numeriskt-test')}
            className="flex-1 py-6 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700"
          >
