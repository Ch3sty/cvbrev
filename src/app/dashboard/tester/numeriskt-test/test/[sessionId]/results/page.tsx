...
import {
  ...
  TOTAL_QUESTIONS,
} from '@/lib/numericalTest/selectPassages';
...
export default function ResultsPage({ params }: PageProps) {
  ...
  const passages = sessionId ? selectPassagesForSession(sessionId) : [];
  ...
  return (
    <div className="container mx-auto py-4 sm:py-6 px-3 sm:px-4 max-w-3xl">
      <div className="space-y-5 sm:space-y-6">
        ...
        <TestResultBridgeContainer testSlug={"numeriskt-test"} quotaFeature={"test:numerical-reasoning"} />
        ...
        <NextLevelCard
          ...
          href="/dashboard/tester/numeriskt-test-v2"
        />
