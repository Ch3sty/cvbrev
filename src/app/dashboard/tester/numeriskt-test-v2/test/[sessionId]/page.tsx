...
import { BarChart3, ChevronRight, Clock, Flag } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { getAllPassages } from '@/lib/numericalTestV2/validator';
import type { Passage, Question, AnswerOption } from '@/lib/numericalTestV2/types';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-slate-900">Numeriskt Resonemang v2</h1>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          >
            ...
            {/* Graph Visualization */}
            {currentPassage.graphData && (
              <GraphVisualization data={currentPassage.graphData} />
            )}
            ...
            >
                  ...
                  <motion.button
                    ...
                    className={`w-full p-4 rounded-xl text-left transition-all duration-200 ${
                      selectedAnswer === option.id
                        ? 'bg-gradient-to-r from-purple-500 to-violet-600 text-white border-2 border-purple-600 shadow-lg'
                        : 'bg-slate-50 text-slate-800 border-2 border-slate-200 hover:border-purple-300 hover:bg-purple-50'
                    }`}
                  >
                    <div className="flex items-center gap-3">
              ...
              <div className="flex gap-3">
                <Button
                  ...
                  className="flex-1 py-6 bg-gradient-to-r from-purple-500 to-violet-600 hover:from-purple-600 hover:to-violet-700 text-white font-semibold disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
