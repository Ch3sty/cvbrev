...
import { Trophy, Clock, Target, TrendingUp, RotateCcw, Home, CheckCircle2 } from 'lucide-react';
...
export default function ResultsPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50/30 py-12 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl shadow-xl border-2 border-orange-200 p-8 mb-6"
        >
          {/* Main Score */}
          <div className="text-center mb-8">
            <p className="text-slate-600 mb-2 font-medium">Din Poäng</p>
            <div className="text-6xl md:text-7xl font-bold bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="flex items-center gap-3 p-4 bg-orange-50 rounded-xl border border-orange-200">
              ...
              <div>
                <p className="text-sm text-orange-600 font-medium">Tid</p>
                <p className="font-bold text-orange-900">{formatTime(timeSpent)}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-4 bg-red-50 rounded-xl border border-red-200">
              ...
              <div>
                <p className="text-sm text-red-600 font-medium">Träffsäkerhet</p>
                <p className="font-bold text-red-900">{percentage}%</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-4 bg-amber-50 rounded-xl border border-amber-200">
              ...
              <div>
                <p className="text-sm text-amber-600 font-medium">Genomsnitt/fråga</p>
        ...
        >
          <Button
            onClick={() => router.push('/dashboard/tester/matrislogik-avancerad')}
            className="flex-1 bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white py-6 rounded-xl"
          >
