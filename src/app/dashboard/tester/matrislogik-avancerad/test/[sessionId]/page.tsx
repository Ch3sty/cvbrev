...
import { QuestionGrid } from '@/components/tests/logicV6/QuestionGrid';
...
import type { Question } from '@/lib/logicTestV6/types.v6';
...
export default function TestSessionPage({ params }: PageProps) {
  ...
  const saveAnswer = useCallback(async (questionIndex: number, selectedIndex: number) => {
    ...
    try {
      await fetch('/api/logicTestV6/answer', {
        method: 'POST',
  ...
  const handleFinishTest = async () => {
    ...
    try {
      const response = await fetch('/api/logicTestV6/complete', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
      ...
      if (data.success || data.message) {
        router.push(`/dashboard/tester/matrislogik-avancerad/test/${sessionId}/results`);
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50/30 pb-56">
      {/* Header */}
      <TestHeader
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
          ...
          >
            ...
            <div className="mb-8 text-center">
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-2 mt-3 px-3 py-1 bg-orange-100 rounded-full border border-orange-200"
              >
        ...
        >
          ...
          <Button
            ...
            className="flex items-center gap-2 bg-gradient-to-r from-orange-600 to-red-600"
          >
            Nästa
