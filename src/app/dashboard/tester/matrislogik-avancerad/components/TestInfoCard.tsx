...
import { Target, Clock, ArrowLeftRight, Brain } from 'lucide-react';

const FEATURES = [
  {
    icon: Target,
    title: '15 frågor',
    sub: '4 svårighetsnivåer',
  },
  {
    icon: Clock,
    title: 'Ca 25 min',
  ...
  {
    icon: Brain,
    title: 'Kombinerade regler',
    sub: 'Flera lager logik',
  },
];
      ...
      <div className="p-5 sm:p-7 md:p-8">
        <div className="mb-5">
          ...
          <p className="text-sm sm:text-base text-slate-600 mt-2 leading-relaxed">
            Det här testet kombinerar flera regler i samma fråga — t.ex. en form
            som både roterar och växlar fyllning. Det ger dig en realistisk bild
            av hur du skulle prestera på Mensa-nivå eller chefsrekrytering.
          </p>
        </div>
