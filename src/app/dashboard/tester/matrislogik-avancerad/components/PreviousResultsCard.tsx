...
import {
  AvanceradCardThumbnail,
  AvanceradEmptyIllustration,
} from './illustrations/AvanceradIcons';
  ...
  return (
    ...
    >
      ...
      <div className="flex-shrink-0">
        <AvanceradCardThumbnail className="w-10 h-10 sm:w-11 sm:h-11" seed={index + score} />
      </div>
  ...
  return (
    ...
    >
      <div className="flex justify-center mb-3">
        <AvanceradEmptyIllustration className="w-24 h-24 sm:w-28 sm:h-28" />
      </div>
      <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-1">
        Inga resultat än
      </h3>
      <p className="text-xs sm:text-sm text-slate-600 max-w-sm mx-auto">
        Avancerad är ett rejält steg upp från grund-testet. Klara av första försöket
        så ser du dina poäng utvecklas här.
      </p>
    </motion.section>
  );
}
