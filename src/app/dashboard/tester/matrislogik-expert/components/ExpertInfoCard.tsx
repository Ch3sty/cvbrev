...
import { Target, Clock, ArrowLeftRight, Workflow } from 'lucide-react';

const FEATURES = [
  {
    icon: Target,
    title: '15 frågor',
    sub: 'Nya varje omgång',
  },
  {
    icon: Clock,
    title: 'Ca 30 min',
  ...
  {
    icon: Workflow,
    title: 'Flerstegsmönster',
    sub: 'Rotation och förflyttning',
  },
];

export default function ExpertInfoCard() {
  return (
    <motion.section
    ...
    >
      <div
        ...
        style={{ background: 'linear-gradient(90deg, #FB923C, #DC2626, #7F1D1D)' }}
      />
      ...
      <div className="p-5 sm:p-7 md:p-8">
        <div className="mb-5">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">
            För dig som siktar högst
          </h2>
          <p className="text-sm sm:text-base text-slate-600 mt-2 leading-relaxed">
            Expertnivån motsvarar de svåraste uppgifterna i skarpa rekryteringstest.
            Mönstren kombinerar rotation, förflyttning och balans i flera steg, så du
            behöver hålla flera regler i huvudet samtidigt. Ta den tid du behöver och
            pausa när du vill. Dina svar sparas automatiskt.
          </p>
        </div>
