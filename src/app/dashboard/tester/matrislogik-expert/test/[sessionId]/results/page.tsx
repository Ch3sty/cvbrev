  ...
  return (
    <div className="container mx-auto py-4 sm:py-6 px-3 sm:px-4 max-w-3xl">
      <div className="space-y-5 sm:space-y-6">
        ...
        <TestResultBridgeContainer testSlug={"matrislogik-expert"} quotaFeature={"test:matrislogik-expert"} />
        ...
        {/* Action buttons */}
        <ResultsActions onRestart={() => router.push('/dashboard/tester/matrislogik-expert')} />
      </div>
    </div>
  );
}
