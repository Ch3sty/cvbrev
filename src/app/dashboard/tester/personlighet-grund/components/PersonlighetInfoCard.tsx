      ...
      <div className="p-5 sm:p-7 md:p-8">
        <div className="mb-5">
          ...
          <p className="text-sm sm:text-base text-slate-600 mt-2 leading-relaxed">
            {variant === 'grund'
              ? 'Big Five är den modell som forskningen vilar mest tungt på. Du svarar på 50 påståenden om dig själv på en skala från 1 till 5. Sedan får du en profil över fem grundläggande personlighetsdimensioner och vad de betyder för din karriär.'
              : 'Den avancerade versionen går djupare. 120 frågor mäter inte bara de fem huvuddimensionerna utan också 30 underliggande facetter, så du får en mer nyanserad bild av vad som driver dig. Inkluderar AI-genererade karriärinsikter.'}
          </p>
        </div>
