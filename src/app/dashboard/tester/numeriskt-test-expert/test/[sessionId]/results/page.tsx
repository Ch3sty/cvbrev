...
import {
  ...
  TOTAL_QUESTIONS,
} from '@/lib/numericalTestExpert/selectPassages';
import {
  getScoreByDifficulty,
  getScoreByType,
} from '@/lib/numericalTestExpert/validator';
...
export default function NumericalExpertResultsPage({ params }: PageProps) {
    ...
    <div className="container mx-auto py-4 sm:py-6 px-3 sm:px-4 max-w-3xl">
      <div className="space-y-5 sm:space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            onClick={() => router.push('/dashboard/tester/numeriskt-test-expert')}
