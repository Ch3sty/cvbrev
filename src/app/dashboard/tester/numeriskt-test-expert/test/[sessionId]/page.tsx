...
export default function NumericalExpertTestPage({ params }: PageProps) {
  ...
  return (
    <NumericalTestSession
      ...
      answerEndpoint="/api/numericalTestExpert/answer"
      completeEndpoint="/api/numericalTestExpert/complete"
      sessionEndpoint="/api/numericalTestExpert/session"
      resultsPath={(id) => `/dashboard/tester/numeriskt-test-expert/test/${id}/results`}
    />
  );
}
