...
export default function CvSelectorCard({ cv, onActivate, isActivating, isLocked = false }: CvSelectorCardProps) {
  return (
    <motion.button
      ...
      className={`group relative w-full text-left rounded-xl border transition-all overflow-hidden focus:outline-none focus:ring-2 disabled:cursor-not-allowed ${
        isLocked
          ? 'bg-neutral-50 border-neutral-200 focus:ring-neutral-300/50'
          : 'bg-white border-neutral-200 hover:border-orange-300 focus:ring-orange-300/50'
      }`}
    >
      ...
      <div className="relative p-5 overflow-hidden">
        ...
        <div className="relative flex items-start gap-3">
          <FileText className="w-5 h-5 text-neutral-700 flex-shrink-0" strokeWidth={2.25} />
