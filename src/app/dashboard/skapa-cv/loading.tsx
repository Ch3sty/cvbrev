 ...
 *
 * Sidan är numera en server component, så det här skelettet syns bara under
 * den korta stunden servern läser sessionen. Desto viktigare att det har exakt
 * skalets form: topprad på 48 px, tunn progressrad, ett stegkort, sticky fot.
 * Ett skelett med fel form byts ut mot något annat när sidan kommer, och det
 * syns som ett hopp även om det bara varar ett ögonblick.
 *
 * Samma mått som skapa-brev/loading.tsx, eftersom båda flödena bor i samma skal.
 */
