...
const ACTIONS: SnabbAtgard[] = [
  {
    ...
    body: 'Vi läser kravprofilen och skriver brevet.',
  ...
  },
  {
    ...
    body: 'Ditt CV mot Arbetsförmedlingens annonser.',
  ...
  },
  {
    ...
    body: 'Vad rekryteringssystemet ser och vad du ändrar.',
  ...
  },
  {
    ...
    Icon: IkonSynlig,
    title: 'Bli upptäckt',
    body: 'Anonym tills du själv svarar rekryteraren.',
