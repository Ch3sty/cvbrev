    ...
    <div className="max-w-7xl mx-auto p-6">
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex items-start gap-3 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="font-bold text-gray-900 text-lg truncate mb-1">{cv.file_name}</h3>
                        ...
                        <motion.button
                          ...
                          className="p-2 text-gray-400 hover:text-red-600 transition-colors rounded-lg hover:bg-red-50 flex-shrink-0"
                    ...
                    <div className="p-6">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <motion.button
                          ...
                          className="flex items-center justify-center px-3 py-2 text-xs bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-lg transition-all shadow-md hover:shadow-lg"
                        ...
                        <motion.button
                          ...
                          className="flex items-center justify-center px-3 py-2 text-xs bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white rounded-lg transition-all shadow-md hover:shadow-lg"
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.98 }}
                        >
      ...
      {cvs.length === 0 && !cvListLoading && (
        <motion.div
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          className="mb-6 border-2 border-dashed border-gray-300 rounded-2xl p-12 bg-gray-50"
        >
