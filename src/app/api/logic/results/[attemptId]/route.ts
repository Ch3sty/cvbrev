...
import { getInterpretation } from '@/lib/logic/scoring';
import type { QuestionBreakdown } from '@/lib/logic/types';

/**
 * GET /api/logic/results/[attemptId]
 * Fetch test results by attempt ID (grundnivå)
 */
