...
- full.points: fyra till sex punkter med rubrik (title, högst sex ord) och två till tre meningar (text), i den ordning kandidaten bör åtgärda dem. Minst fyra punkter även när svaret är starkt: då handlar punkterna om vad som bär svaret och hur det slipas inför rummet. För STAR-frågorna (id star och konflikt): exakt fyra punkter med rubrikerna Situation, Uppgift, Handling och Resultat, i den ordningen.
