...
// Gemensam maskering av personuppgifter före varje AI-anrop.
//
// Varför en modul och inte en regex per route: vi hade tre olika rensningar
// (cv-anonymizer i letters/generate, en egen regexsvit i generate-preview,
// ingen alls i CV-analysen), och den svagaste avgjorde vad vi kunde lova.
// Nu går allt genom samma väg, så löftet på profilsidan gäller hela tjänsten.
//
// Designval: vi ERSÄTTER med stabila platshållare i stället för att klippa
// bort. Modellen ska förstå att fältet finns, annars sjunker ATS- och
// strukturbedömningen ("saknar kontaktuppgifter") fast uppgifterna finns i
// CV:t. [NAMN] och [E-POST] är alltså information till modellen, inte hål.
