// src/lib/verbalTestExpert/validator.ts
// Verbal Expert = argumentationsanalys i numerisk-motorns flervalsformat (passage +
// frågor a/b/c/d). Återanvänder numericalTest-typerna. Validering/scoring per fråge-id.
