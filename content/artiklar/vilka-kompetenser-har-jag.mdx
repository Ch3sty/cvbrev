...
seoTitle: "Vilka kompetenser har jag? Kartlägg dem | jobbcoach.ai"
date: "2026-06-21"
description: "Vet du inte vilka kompetenser du har? Vi visar en konkret metod för att kartlägga dina egna kompetenser steg för steg, även om det känns omöjligt."
...
# --- START: HowTo-data ---
howto:
  name: "Kartlägg dina egna kompetenser"
  description: "Ta fram en tydlig bild av vad du är bra på, steg för steg."
  steps:
    - name: "Inventera vad du faktiskt gjort"
      text: "Lista varje sammanhang (jobb, utbildning, föreningsliv, hobbyer) och skriv vad du gjorde, inte din titel."
    - name: "Ställ de fyra avslöjande frågorna"
      text: "Gräv fram det du tar för givet genom att fråga vad andra ber dig om hjälp med, vad som känns lätt för dig, vilka problem du löser och vad du är stolt över."
    - name: "Fråga andra"
      text: "Be två till tre personer som känner dig i olika sammanhang om vad de tycker du är bra på."
    - name: "Sortera och formulera"
      text: "Sortera listan i kompetenstyper och formulera varje kompetens som något du gör, inte bara ett ord."
    - name: "Matcha mot vad du vill söka"
      text: "Jämför din lista mot jobbannonser inom ditt målområde för att se vilka kompetenser som är viktigast att lyfta."
    - name: "Värdera nivån"
      text: "Bedöm hur stark varje kompetens är (nybörjare, van, stark) för att veta vad du kan lyfta med självförtroende."
# --- SLUT: HowTo-data ---
---
...
<CVExample title="Från butiksjobb till kartlagda kompetenser">
...
Vill du dessutom se var dina kognitiva styrkor ligger, alltså sådant som logiskt tänkande, problemlösning och ordförståelse, kan du [öva på samma typ av tester](/verktyg/rekryteringstester) som arbetsgivare använder vid rekrytering. Det ger en mer objektiv bild av vissa kompetenser än självskattning ensam.
