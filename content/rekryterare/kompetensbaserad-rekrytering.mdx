...
Fällorna nedan är metodens versioner av urvalets klassiska bias-mekanismer, [hela kartan över fällorna och strukturen som stänger dem finns i en egen insikt](/for-rekryterare/insikter/bias-rekrytering).
...
## Var läcker er process? Testa på två minuter

Metoden ovan är en kedja, och kedjan är inte starkare än sitt svagaste steg. Processkollen ställer tio frågor om er senaste rekrytering och pekar ut var den fria bedömningen släpps in:
